...
def test_get_date(fix_get_date):
    ...
    assert get_date(fix_get_date) == ('11.03.2024','11.12.2025', '11.03.2024', '11.03.2024', 'Некорректные данные. Введите дату в формате: ГГГГ-ММ-ДД', '', 'Некорректные данные. Введите дату в формате: ГГГГ-ММ-ДД')