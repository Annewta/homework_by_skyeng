...
def test_get_date(fix_get_date):
    ...
    for el in fix_get_date:
        result_fix = get_date(el)
        result.append(result_fix)
    assert result == (['11.03.2024','11.12.2025', '11.03.2024', '11.05.2024', 'Некорректные данные. Введите дату в формате: ГГГГ-ММ-ДД', 'Некорректные данные. Введите дату в формате: ГГГГ-ММ-ДД', 'Некорректные данные. Введите дату в формате: ГГГГ-ММ-ДД'])